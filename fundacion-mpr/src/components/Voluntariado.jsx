            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600">Porque te ayuda a poder entregar un vínculo de amor en la niñez de un infante.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <Users className="w-5 h-5 mt-1" style={{color: '#B5EAD7'}} />
                  <p className="text-gray-600">Siempre hay algo bueno que aportar.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <BookOpen className="w-5 h-5 mt-1" style={{color: '#FFDAB3'}} />
                  <p className="text-gray-600">Porque la infancia es dónde se entregan los mejores principios y valores y ellos nunca lo van a olvidar.</p>
                </div>
                <div className="flex items-start space-x-3">
                  <Activity className="w-5 h-5 mt-1" style={{color: '#D7BDE2'}} />
                  <p className="text-gray-600">Es un trabajo preventivo qué puede provocar un gran impacto en su juventud y adultez.</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes'].map((dia) => (
                          <label key={dia} className="inline-flex items-center">
                            ...
                            />
                            <span className="ml-2 text-gray-700">{dia}</span>
                          </label>
                        ))}
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                    <div className="space-y-1 text-center">
                      ...
                      {formData.curriculum && (
                        <p className="text-sm text-gray-700 mt-2">Archivo seleccionado: {formData.curriculum.name}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Tu Experiencia y Motivación</h3>
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="experiencia" className="block text-sm font-medium text-gray-700 mb-2">
                        Experiencia previa en voluntariado (Opcional)
                      </label>
                      <textarea
                        id="experiencia"
                        name="experiencia"
                    ...
                    <div>
                      <label htmlFor="motivacion" className="block text-sm font-medium text-gray-700 mb-2">
                        ¿Por qué quieres ser voluntario en Fundación MPR? *
                      </label>
                      <textarea
                        id="motivacion"
                        name="motivacion"
