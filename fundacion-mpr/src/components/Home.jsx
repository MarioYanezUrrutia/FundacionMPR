...
import { Heart, ChevronRight, ChevronLeft, Mail, Download, Target, Users, BookOpen } from 'lucide-react';
...
const Home = () => {
  ...
  const slides = [
    {
      id: 1,
      title: "Tu aporte puede transformar vidas",
      content: (
        <div className="space-y-6">
          <p className="text-xl text-white/90 mb-8">
            Dona hoy y sé parte de la sonrisa y la esperanza de un niño o niña.
          </p>
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="flex items-center">
              <a href="#" className="flex items-center space-x-2">
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{background: 'linear-gradient(135deg, #A7C7E7, #B5EAD7)'}}>
                  <img src={logo}  alt="logo" /> {/* <Heart className="w-6 h-6 text-white" /> */}
                </div>
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                    ...
                    <a href="#impacto" className="block px-4 py-2 text-gray-700 hover:bg-gray-50 transition-colors" style={{'&:hover': {color: '#A7C7E7'}}}>Impacto</a>
                  </div>
                )}
              </div>
      ...
      <section id="quienes-somos" className="py-16" style={{backgroundColor: '#B5EAD7'}}>
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <p className="text-lg text-gray-600">
              Este proyecto comenzó desde la juventud de la Fundadora de Mi Pequeño Refugio, la pastora Graciela Céspedes, quién a través de vivencias propias, servicio y amor pudo conocer de primera mano la inmensa necesidad existente en cuánto a redes de apoyo y alimentación infantil.
            </p>
            <p className="text-lg text-gray-600">
              De esa forma, en el 2018 se comenzaron diversos proyectos que ayudaron a entregar espacios dignos para que los niños y niñas fueran apoyados a través un Comedor Solidario y cuidado integrales post-jornadas escolares, así como también también en horario completo, además de ofrecerles un espacio de crecimiento y distracción.
            </p>
            <p className="text-lg text-gray-600">
              Constituidos legalmente como Organización Sin Fines de Lucro en el año 2022.
            </p>
            <div className="bg-white/20 rounded-lg p-6 mt-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-semibold">Personalidad Jurídica:</span> 329213
                </div>
                <div>
                  <span className="font-semibold">Razón Social:</span> 65.216.119-7
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="impacto" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Nuestro Impacto</h2>
          </div>
          <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Transformamos vidas a través de programas integrales que abordan las necesidades básicas y el sano desarrollo personal y físico de cada niño, generando un impacto positivo, preventivo y duradero en las vidas de las familias y la comunidad que los rodea.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <Users className="w-12 h-12 mx-auto mb-4" style={{color: '#B5EAD7'}} />
                <h3 className="font-bold text-lg mb-2">Familias Apoyadas</h3>
                <p className="text-gray-600">Brindamos apoyo integral a familias vulnerables</p>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <BookOpen className="w-12 h-12 mx-auto mb-4" style={{color: '#FFDAB3'}} />
                <h3 className="font-bold text-lg mb-2">Educación</h3>
                <p className="text-gray-600">Espacios seguros de aprendizaje y desarrollo</p>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <Heart className="w-12 h-12 mx-auto mb-4" style={{color: '#D7BDE2'}} />
                <h3 className="font-bold text-lg mb-2">Alimentación</h3>
                <p className="text-gray-600">Comedor solidario para nutrición infantil</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Visión */}
      <section id="vision" className="py-16" style={{backgroundColor: '#FFDAB3'}}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                  <img src={logo}  alt="logo" />{/* <Heart className="w-5 h-5" /> */}
                </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Los álamos 6760, Lo Prado</span>
                </div>
              </div>
            </div>
